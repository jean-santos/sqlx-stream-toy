...
use self::common::AreaCode;

// use crate::common::AreaCode;
// use fast_sqlite3_inserts as common;
mod common;

pub fn faker_wrapper(mut conn: Connection, count: i64) {
...
pub(crate) fn gen(qt: i64) {
    let conn = rusqlite::Connection::open("basic_batched.db").unwrap();
    conn.execute_batch(
